  ...
  if (!currentStaff) {
    return (
      <div className="p-6">
        ...
        <Link href="/demo/admin/staff/reports" className="text-white text-xs underline mt-2 inline-block">
          Back to Reports
        </Link>
      </div>
    );
  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-6 pt-4 border-t border-zinc-800">
        <Link href="/demo/admin/staff/reports" className="text-zinc-500 hover:text-white text-xs uppercase tracking-wide">
